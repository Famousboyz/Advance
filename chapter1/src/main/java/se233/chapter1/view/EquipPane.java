...
import se233.chapter1.controller.AllCustomHandle;

import static se233.chapter1.controller.AllCustomHandle.GenCharacterHandler.onDragDropped;
import static se233.chapter1.controller.AllCustomHandle.GenCharacterHandler.onDragOver;
...
public class EquipPane extends ScrollPane {
    ...
    private Pane getDetailsPane() {
        ...
        unequip.setText("UnEquipment");
        unequip.setOnAction(new AllCustomHandle.GenCharacterHandler.UnEquip());
